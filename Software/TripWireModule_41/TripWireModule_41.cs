...
namespace Gadgeteer.Modules.IanLee
{
    ...
    public class TripWireModule : GTM.Module
    {
        ...
        public TripWireModule(int socketNumber, int socketNumberTwo)
        {
        ...
        /// <summary>
        /// Gets a value that indicates whether the button of the TripWireModule is pressed.
        /// </summary>
        ...
        /// <summary>
        /// Represents the state of button of the <see cref="TripWireModule"/>.
        /// </summary>
        ...
        /// </summary>
        /// <param name="sender">The <see cref="TripWireModule"/> object that raised the event.</param>
        /// <param name="state">The state of the button of the <see cref="TripWireModule"/></param>
        public delegate void ButtonEventHandler(TripWireModule sender, ButtonState state);

        /// <summary>
        /// Raised when the button of the <see cref="TripWireModule"/> is pressed.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// Raised when the button of the <see cref="TripWireModule"/> is released.
        /// </summary>
        /// <remarks>
        ...
        /// </summary>
        /// <param name="sender">The <see cref="TripWireModule"/> that raised the event.</param>
        /// <param name="buttonState">The state of the button.</param>
        protected virtual void OnButtonEvent(TripWireModule sender, ButtonState buttonState)
        {
